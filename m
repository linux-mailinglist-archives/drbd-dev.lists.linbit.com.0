...
Received: from mail19.linbit.com (mail19.linbit.com [94.177.8.207])
	by mail.lfdr.de (Postfix) with ESMTPS id 2FEEB91D9D5
	for <lists+drbd-dev@lfdr.de>; Mon,  1 Jul 2024 10:22:50 +0200 (CEST)
Received: from mail19.linbit.com (localhost [127.0.0.1])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 763C34206CF;
	Mon,  1 Jul 2024 10:22:47 +0200 (CEST)
X-Original-To: drbd-dev@lists.linbit.com
Delivered-To: drbd-dev@lists.linbit.com
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 1D76C420657
	for <drbd-dev@lists.linbit.com>; Mon,  1 Jul 2024 10:22:42 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
	d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
	t=1719822164; x=1751358164;
	h=date:from:to:cc:subject:message-id:references:
	in-reply-to:mime-version;
	bh=MFcVXUwoUwE+MZo1Atwoe6rRlxKOPawCw+svxWuKTtk=;
	b=apld0ypmPrc4KuQPXdpWInqvy8Y/9lTam8AbgGO4pgzT5miHall1jYeP
	8KdycSR8UhSumVpdcfrcs+8pppLaR0NKomSm7kFHNTE4yvQWX9KqQGbgd
	kLs/xXJ4wBSV+vtwh+OamO6Rtj+H4t/uZzKbFvbD2bx3zpT40uPLBug9d
	hU0qOMAj1ZLb+kVuSDIVMvdiPmIlQNUe1OXaSVKiDx5b6EaB2nBEXEJME
	vHPT7tooKoPWf+U9c2JbnAhA8QTPSNlOElw+HQt1aLRY9jnA40DaHZBDJ
	45OePjKEI+tCUdxRZW2FlACzMqcRqZ7PkXncySpzvvXiN8GyNEJL3bOdp Q==;
X-CSE-ConnectionGUID: nT2pYoFKRkKtzQO0/pmGdQ==
X-CSE-MsgGUID: lzNfbK63SRKdgNPP+lVHYQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11119"; a="39439695"
X-IronPort-AV: E=Sophos;i="6.09,175,1716274800"; d="scan'208";a="39439695"
...
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.09,175,1716274800"; d="scan'208";a="50321254"
...
Received: from LV3PR11MB8603.namprd11.prod.outlook.com (2603:10b6:408:1b6::9)
	...
	Mon, 1 Jul 2024 08:22:37 +0000
Received: from LV3PR11MB8603.namprd11.prod.outlook.com
	([fe80::4622:29cf:32b:7e5c]) by LV3PR11MB8603.namprd11.prod.outlook.com
	([fe80::4622:29cf:32b:7e5c%2]) with mapi id 15.20.7719.029;
	Mon, 1 Jul 2024 08:22:35 +0000
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
	...
	PTR:; CAT:NONE;
	SFS:(13230040)(7416014)(376014)(366016)(1800799024); DIR:OUT;
	SFP:1101; 
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 01 Jul 2024 08:22:35.6234 (UTC)
