...
Received: from mail19.linbit.com (mail19.linbit.com [159.69.154.96])
	by mail.lfdr.de (Postfix) with ESMTPS id 571C8506D4F
	for <lists+drbd-dev@lfdr.de>; Tue, 19 Apr 2022 15:16:08 +0200 (CEST)
Received: from mail19.linbit.com (localhost [127.0.0.1])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 5B1F0420368;
	Tue, 19 Apr 2022 15:16:07 +0200 (CEST)
X-Original-To: drbd-dev@lists.linbit.com
Delivered-To: drbd-dev@lists.linbit.com
Received: from mx0b-00069f02.pphosted.com (mx0b-00069f02.pphosted.com
	[205.220.177.32])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 4F9284201B9
	for <drbd-dev@lists.linbit.com>; Tue, 19 Apr 2022 15:16:05 +0200 (CEST)
Received: from pps.filterd (m0246631.ppops.net [127.0.0.1])
	by mx0b-00069f02.pphosted.com (8.16.1.2/8.16.1.2) with SMTP id
	23JBsRJ4019231; Tue, 19 Apr 2022 12:02:44 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=oracle.com;
	...
	NfAyU8bpRJG2F7ix/eGzB+R25mqyYKtPHmV/fkjAj1cJnn9659Z2MswMUQT0Iqj3A/sc
	qw== 
...
Received: from pps.filterd (phxpaimrmta03.imrmtpd1.prodappphxaev1.oraclevcn.com
	...
	(8.16.1.2/8.16.1.2) with SMTP id 23JC1i8b035322; 
...
Received: from PH0PR10MB5706.namprd10.prod.outlook.com (2603:10b6:510:148::10)
	...
	cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.5164.25;
	Tue, 19 Apr 2022 12:02:41 +0000
Received: from PH0PR10MB5706.namprd10.prod.outlook.com
	([fe80::d414:7654:e1b8:4306]) by
	PH0PR10MB5706.namprd10.prod.outlook.com
	([fe80::d414:7654:e1b8:4306%9]) with mapi id 15.20.5164.025;
	Tue, 19 Apr 2022 12:02:41 +0000
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:; IPV:NLI; SFV:NSPM;
	H:PH0PR10MB5706.namprd10.prod.outlook.com; PTR:; CAT:NONE;
...
X-Proofpoint-Spam-Details: rule=notspam policy=default score=0 mlxscore=0
	...
	engine=8.12.0-2202240000 definitions=main-2204190068
