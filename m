...
Received: from mail19.linbit.com (mail19.linbit.com [159.69.154.96])
	by mail.lfdr.de (Postfix) with ESMTPS id 8364C7A40CA
	for <lists+drbd-dev@lfdr.de>; Mon, 18 Sep 2023 08:00:34 +0200 (CEST)
Received: from mail19.linbit.com (localhost [127.0.0.1])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 69AE942032F;
	Mon, 18 Sep 2023 08:00:34 +0200 (CEST)
X-Original-To: drbd-dev@lists.linbit.com
Delivered-To: drbd-dev@lists.linbit.com
Received: from esa6.hgst.iphmx.com (esa6.hgst.iphmx.com [216.71.154.45])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 4677142032F
	for <drbd-dev@lists.linbit.com>; Mon, 18 Sep 2023 08:00:28 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
	d=wdc.com; i=@wdc.com; q=dns/txt; s=dkim.wdc.com;
	t=1695016829; x=1726552829;
	h=from:to:cc:subject:date:message-id:references:
	in-reply-to:content-id:content-transfer-encoding: mime-version;
	bh=joufdrNO2/FLdgGzlnaieoHfZ28FYCwNXGhrZ08f24E=;
	b=fxuTSVhtqLLH0064RmRXTCcy+EFUB/taIXzayNKrYH0F9cdNYOAp5BGb
	jSbjVxdAwFyy5um3rz6VNfKqrQ3YR0+XorAtK6Gcea2580mrvKkT9zio6
	O7ehnQT29HdFBRR6qWpiRGF6nBo/9/QTZmFoc/4CfZbEiu9D5tPTHXxiz
	77/uo00DZQNFfPVJYrHF4CDRWEWOMJiKIefWqv8fIBEYphu8SbIRUwvYP
	lSqHMd0HfDKorKQl9nssKEN3nCcXxpSZbH2N4BOb2G8k0346z1r5Nl73p
	ZroUJAl09oAv8CuxnY7RQh8koIWbcHHW/BEFD71itsdDy9qujc21YWpZW g==;
...
Subject: Re: [Drbd-dev] [PATCH v3 2/4] iomap: simplify iomap_init() with
	PAGE_SECTORS
