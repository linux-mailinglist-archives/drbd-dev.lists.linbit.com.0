...
Received: from mail19.linbit.com (mail19.linbit.com [159.69.154.96])
	by mail.lfdr.de (Postfix) with ESMTPS id 070CC30425E
	for <lists+drbd-dev@lfdr.de>; Tue, 26 Jan 2021 16:25:04 +0100 (CET)
Received: from mail19.linbit.com (localhost [127.0.0.1])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id D31A942060C;
	Tue, 26 Jan 2021 16:25:03 +0100 (CET)
X-Original-To: drbd-dev@lists.linbit.com
Delivered-To: drbd-dev@lists.linbit.com
Received: from casper.infradead.org (casper.infradead.org [90.155.50.34])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 9CE4942053E
	for <drbd-dev@lists.linbit.com>; Tue, 26 Jan 2021 16:25:02 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	d=infradead.org; s=casper.20170209;
	h=Content-Transfer-Encoding:MIME-Version:
	References:In-Reply-To:Message-Id:Date:Subject:Cc:To:From:Sender:Reply-To:
	Content-Type:Content-ID:Content-Description;
	bh=D/eDIBgr0QhzI/ySPX/2hbyfNquR7e3bfpvNVnt2JfU=;
	b=D0vECFFPgjNDQdJXrlwGlO9SXK
...
Subject: [Drbd-dev] [PATCH 16/17] nilfs2: remove cruft in nilfs_alloc_seg_bio
