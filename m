...
Received: from mail19.linbit.com (mail19.linbit.com [159.69.154.96])
	by mail.lfdr.de (Postfix) with ESMTPS id EB6AD307B91
	for <lists+drbd-dev@lfdr.de>; Thu, 28 Jan 2021 18:00:27 +0100 (CET)
Received: from mail19.linbit.com (localhost [127.0.0.1])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 2E85942066C;
	Thu, 28 Jan 2021 18:00:23 +0100 (CET)
X-Original-To: drbd-dev@lists.linbit.com
Delivered-To: drbd-dev@lists.linbit.com
Received: from userp2130.oracle.com (userp2130.oracle.com [156.151.31.86])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 1A2014207DE
	for <drbd-dev@lists.linbit.com>; Thu, 28 Jan 2021 13:44:04 +0100 (CET)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=oracle.com;
	...
	YZHYf/IJQe1vowSGdXaismmdrzSvukfzxgZgsVxZUPtuzVPDomuh8lDLOEXGRn0omBFg
	Fg== 
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:; IPV:NLI; SFV:NSPM;
	H:CH2PR10MB4118.namprd10.prod.outlook.com; PTR:; CAT:NONE;
...
Cc: shaggy@kernel.org, sergey.senozhatsky.work@gmail.com, snitzer@redhat.com,
	...
	len.brown@intel.com, konrad.wilk@oracle.com, hare@suse.de,
...
Subject: Re: [Drbd-dev] [RFC PATCH 19/34] fs/jfs/jfs_logmgr.c: use bio_new
	in lbmRead
