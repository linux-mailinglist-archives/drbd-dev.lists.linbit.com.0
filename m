...
Received: from mail19.linbit.com (mail19.linbit.com [159.69.154.96])
	by mail.lfdr.de (Postfix) with ESMTPS id C420B7A40CC
	for <lists+drbd-dev@lfdr.de>; Mon, 18 Sep 2023 08:01:34 +0200 (CEST)
Received: from mail19.linbit.com (localhost [127.0.0.1])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id AC6524203AD;
	Mon, 18 Sep 2023 08:01:34 +0200 (CEST)
X-Original-To: drbd-dev@lists.linbit.com
Delivered-To: drbd-dev@lists.linbit.com
Received: from esa6.hgst.iphmx.com (esa6.hgst.iphmx.com [216.71.154.45])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 531A44203AD
	for <drbd-dev@lists.linbit.com>; Mon, 18 Sep 2023 08:01:29 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
	d=wdc.com; i=@wdc.com; q=dns/txt; s=dkim.wdc.com;
	t=1695016889; x=1726552889;
	h=from:to:cc:subject:date:message-id:references:
	in-reply-to:content-id:content-transfer-encoding: mime-version;
	bh=joufdrNO2/FLdgGzlnaieoHfZ28FYCwNXGhrZ08f24E=;
	b=NKbteXM5QWCbnZy/NKuKRRmVR69GuT5+O/pdSjZJ5W4cEtiG6lgUQMiH
	4L5mDQ2sU1T+7YVmnJEmvNdY6DonLb4yLvNs+rctRN1IbMgKuyAb7DFrY
	NR158cwKniOnwyYfja7MkZAkteezMvyslSZfRfAMcPsCzvbsh1GkQwOnU
	RCEPUtr2pAe86Hs9AxFJbVWhf+ZNSk0H2lktzcCBKPu1P6aRWfbs+5DK+
	ZK2OvavVGacPNmGtS8PvN/IJB5T1bjc9zxkliUDEPSa8v2w5PItnvltCw
	n1AqdTYG5S7xQE1yck5N4wGR6Nfzbyam1q9Q9bLjjeKAuWS0fD2rB1kiL A==;
...
Subject: Re: [Drbd-dev] [PATCH v3 3/4] dm bufio: simplify by using
	PAGE_SECTORS_SHIFT
