...
Received: from mail19.linbit.com (mail19.linbit.com [94.177.8.207])
	by mail.lfdr.de (Postfix) with ESMTPS id 96B66915C2E
	for <lists+drbd-dev@lfdr.de>; Tue, 25 Jun 2024 04:29:24 +0200 (CEST)
Received: from mail19.linbit.com (localhost [127.0.0.1])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 951E242039E;
	Tue, 25 Jun 2024 04:29:22 +0200 (CEST)
X-Original-To: drbd-dev@lists.linbit.com
Delivered-To: drbd-dev@lists.linbit.com
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.21])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id EA6A84200BE
	for <drbd-dev@lists.linbit.com>; Tue, 25 Jun 2024 04:29:17 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
	d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
	t=1719282558; x=1750818558;
	h=date:from:to:cc:subject:message-id:
	content-transfer-encoding:mime-version;
	bh=V11zIKqk/6wupkP1AL+HaUeiYuY0nVFIKfm6Rg0OkQI=;
	b=oI9DPfWOgOWzyCPSLz9DS+Hv5xgQA3APqyWhtd1TfvgDHVLwgUBxCc07
	1oXjuhzmI4FKgAxfhWxkRelVfZAmNKKlQMOJZgUdA69oh2XNrX9tBmlht
	Gz5Dib7bIfDqN85HNL9ViaxLD6CcMMcWjhUJ7yEuSmO3s2PzJngwtH0+8
	HRz6M50QRd9PrTWTkqmC/ZIDC+MCMi8JxmHEhpEFZDs6gsbPlPVMcecWN
	20G/a4BVMcWl1f+yB/4XsoGVYd0L1JfQgqyt0AQK/VnCx3o7XrMDCgAt7
	O8eVGegx+P8M1el4/mqgqAHrUbMk3ltqsjgpJDytPLxcfaDwgtWZCtrf0 Q==;
X-CSE-ConnectionGUID: hsKPNWZxR86vFlfUf2IFaQ==
X-CSE-MsgGUID: mp9nYsvJQSCyWrQdVnG1WQ==
X-IronPort-AV: E=McAfee;i="6700,10204,11113"; a="16243605"
X-IronPort-AV: E=Sophos;i="6.08,263,1712646000"; d="scan'208";a="16243605"
...
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.08,263,1712646000"; d="scan'208";a="43476889"
...
Received: from LV3PR11MB8603.namprd11.prod.outlook.com (2603:10b6:408:1b6::9)
	...
	cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.7677.29;
	Tue, 25 Jun 2024 02:29:11 +0000
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
	...
	PTR:; CAT:NONE;
	SFS:(13230037)(366013)(376011)(7416011)(1800799021); DIR:OUT;
	SFP:1101; 
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 25 Jun 2024 02:29:10.9499 (UTC)
