...
Received: from mail19.linbit.com (mail19.linbit.com [159.69.154.96])
	by mail.lfdr.de (Postfix) with ESMTPS id CD0564315B2
	for <lists+drbd-dev@lfdr.de>; Mon, 18 Oct 2021 12:15:25 +0200 (CEST)
Received: from mail19.linbit.com (localhost [127.0.0.1])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id B3FDB420FCA;
	Mon, 18 Oct 2021 12:15:25 +0200 (CEST)
X-Original-To: drbd-dev@lists.linbit.com
Delivered-To: drbd-dev@lists.linbit.com
Received: from bombadil.infradead.org (bombadil.infradead.org
	[198.137.202.133])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 0B03D420FCA
	for <drbd-dev@lists.linbit.com>; Mon, 18 Oct 2021 12:12:06 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	d=infradead.org; s=bombadil.20210309; h=Content-Transfer-Encoding:
	MIME-Version:References:In-Reply-To:Message-Id:Date:Subject:Cc:To:From:Sender
	:Reply-To:Content-Type:Content-ID:Content-Description;
	bh=fFiyZJBuziQrITu6AwTrNzk8Coj3yxtnkFBgzy+4utY=;
	b=f1ZTns0vT6m845qkA0baYXk2PG
...
Subject: [Drbd-dev] [PATCH 07/30] nvmet: use bdev_nr_bytes instead of open
	coding it
