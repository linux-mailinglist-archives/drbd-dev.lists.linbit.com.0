...
Received: from mail19.linbit.com (mail19.linbit.com [94.177.8.207])
	by mail.lfdr.de (Postfix) with ESMTPS id C727D919D4B
	for <lists+drbd-dev@lfdr.de>; Thu, 27 Jun 2024 04:36:17 +0200 (CEST)
Received: from mail19.linbit.com (localhost [127.0.0.1])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 0CBA14203C6;
	Thu, 27 Jun 2024 04:36:11 +0200 (CEST)
X-Original-To: drbd-dev@lists.linbit.com
Delivered-To: drbd-dev@lists.linbit.com
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.11])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 47CE24200BE
	for <drbd-dev@lists.linbit.com>; Thu, 27 Jun 2024 04:36:01 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
	d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
	t=1719455762; x=1750991762;
	h=date:from:to:cc:subject:message-id:references:
	in-reply-to:mime-version;
	bh=Tm5fXzj/0p2EHgLOiFB38ADrMsp4/BzPcBMAMvA3Zcg=;
	b=Ty73AUsDup/2H1EnPqU47qsGY0TxdRs3dAbYg+AasJSsFnF10ayCq695
	ppOTyJDdR0/vM1WJFE2v3FRqcFBY6tmFlOvNaDPN5BnrQiCwoVC1bAtLL
	EtOki5seBo6rAvPvjZ8B3+YAcwZZljcsmgXPzaiHYXtNxAons7B9o4kic
	LYHgzqboaTXZel+SAKy/G/gn6UDj3n6i1XDl8R6Eis+d4rchCpuMIW7Nk
	lrXZu5SbDrV444lsB6j+JLl9Vr8swixJsFar1ER6k4TTzxwyrdbYPeBXw
	qLq9mB78AsWPBUGh1zUhTb6c/ewm5kabZj0uY7cPS1fE6sMiQf2pbu6jW Q==;
X-CSE-ConnectionGUID: llJbdX0aTmykoKukLsdbWQ==
X-CSE-MsgGUID: vnvVUfenRPSOzKRcEWBLmw==
X-IronPort-AV: E=McAfee;i="6700,10204,11115"; a="27150861"
X-IronPort-AV: E=Sophos;i="6.08,268,1712646000"; d="scan'208";a="27150861"
...
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.08,268,1712646000"; d="scan'208";a="44643323"
...
Received: from LV3PR11MB8603.namprd11.prod.outlook.com (2603:10b6:408:1b6::9)
	...
	cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.7698.30;
	Thu, 27 Jun 2024 02:35:55 +0000
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
	...
	PTR:; CAT:NONE;
	SFS:(13230040)(366016)(376014)(7416014)(1800799024); DIR:OUT;
	SFP:1101; 
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 27 Jun 2024 02:35:55.6518 (UTC)
