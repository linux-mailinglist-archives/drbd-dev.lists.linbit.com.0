...
Received: from mail19.linbit.com (mail19.linbit.com [94.177.8.207])
	by mail.lfdr.de (Postfix) with ESMTPS id 6A714914945
	for <lists+drbd-dev@lfdr.de>; Mon, 24 Jun 2024 14:03:35 +0200 (CEST)
Received: from mail19.linbit.com (localhost [127.0.0.1])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 21E204203BF;
	Mon, 24 Jun 2024 14:03:33 +0200 (CEST)
X-Original-To: drbd-dev@lists.linbit.com
Delivered-To: drbd-dev@lists.linbit.com
X-Greylist: delayed 428 seconds by postgrey-1.31 at mail19;
	Mon, 24 Jun 2024 10:33:21 CEST
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.11])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id BD85D4205D4
	for <drbd-dev@lists.linbit.com>; Mon, 24 Jun 2024 10:33:21 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
	d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
	t=1719218003; x=1750754003;
	h=date:from:to:cc:subject:message-id:
	content-transfer-encoding:mime-version;
	bh=fGhZO2FmE8nE29RUwQ5tssL6/n/FksubW9qRWYQIPYE=;
	b=Bcp3bHWDZEPBuGoKAz1UHRCEpk/y0K31hRKW5h8e2oi4pLv6fcURAFJS
	cPtdhSw7W+EmCavUx/J7stHvUehhcma19TABqrplrtKaW46uesIT7ooTZ
	bk8gBVWqVayfGL+o/pKKbGcBCMGn4KHh3lNw7FvCB/drRzMDGXcFysVvx
	/lvyyEa73HaBwT7Rs9SKXXQsW0n5h2FZzW24pBDlGG9e5/INkfKeZ6sZ0
	6rRdFp3JPJGp9uizP1IxIQOwulPRz3dUDaLVMl1hAeu5PVh0blKMcppWu
	8pPr+dPeAc4uqcOU0zWT328RRP2v6MUZdQu1rjzrkbqDUr4iuV9EPNUCi A==;
X-CSE-ConnectionGUID: EUZ1tFgnQLeerFeTcTXWgA==
X-CSE-MsgGUID: tn+xtgv1TJ6WnuC3C3/yPw==
X-IronPort-AV: E=McAfee;i="6700,10204,11112"; a="26765433"
X-IronPort-AV: E=Sophos;i="6.08,261,1712646000"; d="scan'208";a="26765433"
...
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.08,261,1712646000"; d="scan'208";a="43035911"
...
Received: from LV3PR11MB8603.namprd11.prod.outlook.com (2603:10b6:408:1b6::9)
	...
	cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.7698.19;
	Mon, 24 Jun 2024 08:26:05 +0000
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
	...
	PTR:; CAT:NONE;
	SFS:(13230037)(1800799021)(376011)(7416011)(366013); DIR:OUT;
	SFP:1101; 
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 24 Jun 2024 08:26:05.2612 (UTC)
...
X-Mailman-Approved-At: Mon, 24 Jun 2024 14:03:29 +0200
