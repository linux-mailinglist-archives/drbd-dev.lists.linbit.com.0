...
Received: from mail19.linbit.com (mail19.linbit.com [159.69.154.96])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E93360995D
	for <lists+drbd-dev@lfdr.de>; Mon, 24 Oct 2022 06:45:07 +0200 (CEST)
Received: from mail19.linbit.com (localhost [127.0.0.1])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 6FA224203A1;
	Mon, 24 Oct 2022 06:45:06 +0200 (CEST)
X-Original-To: drbd-dev@lists.linbit.com
Delivered-To: drbd-dev@lists.linbit.com
X-Greylist: delayed 428 seconds by postgrey-1.31 at mail19;
	Fri, 21 Oct 2022 02:47:15 CEST
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 76C8842096A
	for <drbd-dev@lists.linbit.com>; Fri, 21 Oct 2022 02:47:15 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
	d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
	t=1666313235; x=1697849235;
	h=date:from:to:cc:subject:message-id:references:
	mime-version:in-reply-to;
	bh=Sz1ZBCtXd6EvBU8s9i8YzXPr2XW/1oFAXdE3sdLZbG0=;
	b=YZnyzsIjt3/BE/m7ltzi8FN4KIrEG+ku2EpN1NgeHn5JAfO9Uyftd4Ze
	skDKUdqpnFxBfFEQbGvVag4F7t9nxBnfDiOh++5ahCfAM6Yl5X7FqsHLp
	3hx9FMkw+2V/S86tNyyzjF2SHCkpIDEj32RC/RgR9nAM5U/x/Ny/hSjx1
	XVbMieFY/RJ5EYaLwTpEYwChTHUxC40IPsjArkTavsjwPd0atwVmMySMI
	HtNIGzwMEUkJrfvPsi99cWvnpXOWhHvyy+w+K6dlWF1PDkC6E2EBZpDO0
	LXub9O5UsIs8A1bQjARhwUCNe+RQt8qsmc1nu6LNeLWAuKP/4LvpjXzL+ Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10506"; a="305611925"
X-IronPort-AV: E=Sophos;i="5.95,200,1661842800"; d="scan'208";a="305611925"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
	by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
	20 Oct 2022 17:40:05 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10506"; a="959298028"
X-IronPort-AV: E=Sophos;i="5.95,200,1661842800"; d="scan'208";a="959298028"
Received: from lkp-server02.sh.intel.com (HELO b6d29c1a0365) ([10.239.97.151])
	by fmsmga005.fm.intel.com with ESMTP; 20 Oct 2022 17:40:02 -0700
Received: from kbuild by b6d29c1a0365 with local (Exim 4.96)
	(envelope-from <lkp@intel.com>) id 1olg4w-0001tz-0F;
...
X-Mailman-Approved-At: Mon, 24 Oct 2022 06:45:05 +0200
Cc: kbuild-all@lists.01.org, Philipp Reisner <philipp.reisner@linbit.com>,
	linux-kernel@vger.kernel.org, linux-block@vger.kernel.org,
	Lars Ellenberg <lars.ellenberg@linbit.com>, drbd-dev@lists.linbit.com
Subject: Re: [Drbd-dev] [PATCH v2] drbd: Store op in drbd_peer_request
