...
Received: from mail19.linbit.com (mail19.linbit.com [94.177.8.207])
	by mail.lfdr.de (Postfix) with ESMTPS id 6EAA39178C7
	for <lists+drbd-dev@lfdr.de>; Wed, 26 Jun 2024 08:19:00 +0200 (CEST)
Received: from mail19.linbit.com (localhost [127.0.0.1])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id B7FA34200BE;
	Wed, 26 Jun 2024 08:18:59 +0200 (CEST)
X-Original-To: drbd-dev@lists.linbit.com
Delivered-To: drbd-dev@lists.linbit.com
X-Greylist: delayed 428 seconds by postgrey-1.31 at mail19;
	Wed, 26 Jun 2024 08:18:55 CEST
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.10])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 3A3164200BE
	for <drbd-dev@lists.linbit.com>; Wed, 26 Jun 2024 08:18:55 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
	d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
	t=1719382735; x=1750918735;
	h=date:from:to:cc:subject:message-id:references:
	content-transfer-encoding:in-reply-to:mime-version;
	bh=t5kFOL26FKqErH7/75/kLz8JVthUyyur+5ROSrjsM28=;
	b=dyjUIUoGpd06mxCLiCHm1xetQgpfMwwazzuDAOvYXQMB+NsCP6AOurIs
	66LHZRttPoXSggDKoHIBnRoZZyWyXYlL42Y/ZotGAdB10BbtLC+EqGnns
	1KiEP1bUjOnxWbPEr1lgcjCQe7zPs5WVAZYsihZ5KZXQVftLkV9YHvVNc
	9wifT3jmy8brja2wLDnWHkIvsyrxmsQ/aCUnPBeJoA9uv1plE46t8gQWH
	eC2kK8Ni5q+hkubmB0BijJSqbeeQ1WK9l5zxdzKepRePlUhlUK3CIULms
	PCh0ZO5kJBEiCF34CQMMelxCbE8h7PLmOvccToNb9tNzpj3xUyzTKIiC5 Q==;
X-CSE-ConnectionGUID: Pyy2LQYvScaA4d5OjJ/Itw==
X-CSE-MsgGUID: U/PWM6zRRc6Ey4XjqWpbBg==
X-IronPort-AV: E=McAfee;i="6700,10204,11114"; a="27841668"
X-IronPort-AV: E=Sophos;i="6.08,266,1712646000"; d="scan'208";a="27841668"
...
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.08,266,1712646000"; d="scan'208";a="49058636"
...
Received: from LV3PR11MB8603.namprd11.prod.outlook.com (2603:10b6:408:1b6::9)
	...
	cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.7698.32;
	Wed, 26 Jun 2024 06:11:29 +0000
Received: from LV3PR11MB8603.namprd11.prod.outlook.com
	([fe80::4622:29cf:32b:7e5c]) by LV3PR11MB8603.namprd11.prod.outlook.com
	([fe80::4622:29cf:32b:7e5c%2]) with mapi id 15.20.7698.025;
	Wed, 26 Jun 2024 06:11:28 +0000
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
	...
	PTR:; CAT:NONE;
	SFS:(13230038)(366014)(1800799022)(7416012)(376012); DIR:OUT;
	SFP:1101; 
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 26 Jun 2024 06:11:28.9475 (UTC)
