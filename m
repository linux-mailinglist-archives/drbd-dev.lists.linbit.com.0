...
Received: from mail19.linbit.com (mail19.linbit.com [94.177.8.207])
	by mail.lfdr.de (Postfix) with ESMTPS id B4148903966
	for <lists+drbd-dev@lfdr.de>; Tue, 11 Jun 2024 12:57:50 +0200 (CEST)
Received: from mail19.linbit.com (localhost [127.0.0.1])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 971454209D1;
	Tue, 11 Jun 2024 12:57:48 +0200 (CEST)
X-Original-To: drbd-dev@lists.linbit.com
Delivered-To: drbd-dev@lists.linbit.com
X-Greylist: delayed 428 seconds by postgrey-1.31 at mail19;
	Tue, 11 Jun 2024 12:57:45 CEST
Received: from esa6.hgst.iphmx.com (esa6.hgst.iphmx.com [216.71.154.45])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 084074208FB
	for <drbd-dev@lists.linbit.com>; Tue, 11 Jun 2024 12:57:44 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
	d=wdc.com; i=@wdc.com; q=dns/txt; s=dkim.wdc.com;
	t=1718103465; x=1749639465;
	h=from:to:cc:subject:date:message-id:references:
	in-reply-to:content-id:content-transfer-encoding: mime-version;
	bh=joufdrNO2/FLdgGzlnaieoHfZ28FYCwNXGhrZ08f24E=;
	b=LLM/joN+08ynb5tKGOMSum9GHyN0XIZg7NRhhUqpi/yx/MXjn8j3iCDQ
	nN8HesBO9gaH8itqm4W2AFLVHGi/5UH3RrTYYwPiM644Lkp4RODsdTp3g
	zX0DI1/kx27oQDwsp29n8T4SfKHrYKHzBqEf/9Vhj7m293Mwu/iXEJbxD
	yd30TwLWOS6hV/d3mH1T/ZKeHNovuVkrYRbWK/w3HIYHdHcIvoWw27fNY
	hUlBueP3hRn1M5lrUM+/RCBD7o344quVFnZZ2AuLiQaup7wcYT1KAxpA2
	C1/HO51Uds01xnTt7qxj+k4hVjmfLH4+CD/ehe51mstxgOeFKIbmSZdMa Q==;
X-CSE-ConnectionGUID: XG+0u+qGSs+VPGBVXSu+Jw==
X-CSE-MsgGUID: lJhORMbQS2qna7/3Ae/3wg==
X-IronPort-AV: E=Sophos;i="6.08,229,1712592000"; d="scan'208";a="18778898"
...
Received: from PH0PR04MB7416.namprd04.prod.outlook.com (2603:10b6:510:12::17)
	...
	cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.7633.37;
	Tue, 11 Jun 2024 10:50:30 +0000
Received: from PH0PR04MB7416.namprd04.prod.outlook.com
	([fe80::ee22:5d81:bfcf:7969]) by
	PH0PR04MB7416.namprd04.prod.outlook.com
	([fe80::ee22:5d81:bfcf:7969%4]) with mapi id 15.20.7633.037;
	Tue, 11 Jun 2024 10:50:30 +0000
...
x-forefront-antispam-report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:; IPV:NLI; SFV:NSPM;
	...
	SFS:(13230031)(376005)(7416005)(1800799015)(366007)(38070700009);
	DIR:OUT; SFP:1101; 
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 11 Jun 2024 10:50:30.5035 (UTC)
