...
Received: from mail19.linbit.com (mail19.linbit.com [159.69.154.96])
	by mail.lfdr.de (Postfix) with ESMTPS id DBFB0431080
	for <lists+drbd-dev@lfdr.de>; Mon, 18 Oct 2021 08:25:49 +0200 (CEST)
Received: from mail19.linbit.com (localhost [127.0.0.1])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 3E327420FCE;
	Mon, 18 Oct 2021 08:25:44 +0200 (CEST)
X-Original-To: drbd-dev@lists.linbit.com
Delivered-To: drbd-dev@lists.linbit.com
X-Greylist: delayed 309 seconds by postgrey-1.31 at mail19;
	Fri, 15 Oct 2021 20:07:24 CEST
Received: from de-smtp-delivery-102.mimecast.com
	(de-smtp-delivery-102.mimecast.com [194.104.111.102])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 2ACA042108A
	for <drbd-dev@lists.linbit.com>; Fri, 15 Oct 2021 20:07:24 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.com;
	s=mimecast20200619; t=1634321243;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	content-transfer-encoding:content-transfer-encoding:
	in-reply-to:in-reply-to:references:references;
	bh=m4dfeoXG+Sb747r1kiHnXbAbgB6Mk9qwJHpOSq1ikW0=;
	b=O1Rw2bOQfo9C85PgHmRETUVqztuMT2OcAh+9n8hj1gOOcwDcR5qa3iV9RG3essgro88K3A
	ji8YG3dGF9WuZtX+amAKFKCyYjuvuDBrTMUeVt2pNb7pUexcmaQHyeXX5jD1FhUmnDWFXq
	I8D3jZRi4U6guQELFfQJD9EjmbiHQ9Q=
...
X-Forefront-Antispam-Report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:; IPV:NLI; SFV:NSPM;
	H:AM5PR04MB3089.eurprd04.prod.outlook.com; PTR:; CAT:NONE;
...
Subject: Re: [Drbd-dev] [PATCH 04/30] drbd: use bdev_nr_sectors instead of
	open coding it
