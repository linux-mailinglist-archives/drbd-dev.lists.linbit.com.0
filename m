...
Received: from mail19.linbit.com (mail19.linbit.com [94.177.8.207])
	by mail.lfdr.de (Postfix) with ESMTPS id 2681290FCCE
	for <lists+drbd-dev@lfdr.de>; Thu, 20 Jun 2024 08:37:19 +0200 (CEST)
Received: from mail19.linbit.com (localhost [127.0.0.1])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id C24264202E7;
	Thu, 20 Jun 2024 08:37:17 +0200 (CEST)
X-Original-To: drbd-dev@lists.linbit.com
Delivered-To: drbd-dev@lists.linbit.com
Received: from mail-wm1-f47.google.com (mail-wm1-f47.google.com
	[209.85.128.47])
	by mail19.linbit.com (LINBIT Mail Daemon) with ESMTP id 5A8E9420304
	for <drbd-dev@lists.linbit.com>; Wed, 19 Jun 2024 17:23:23 +0200 (CEST)
Received: by mail-wm1-f47.google.com with SMTP id
	5b1f17b1804b1-4217926991fso60168795e9.3
	for <drbd-dev@lists.linbit.com>; Wed, 19 Jun 2024 08:23:23 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
	d=gmail.com; s=20230601; t=1718810603; x=1719415403;
	darn=lists.linbit.com; 
	h=to:references:message-id:content-transfer-encoding:cc:date
	:in-reply-to:from:subject:mime-version:from:to:cc:subject:date
	:message-id:reply-to;
	bh=HSVLHkgMSUqxWcbc1T+fsQsit0Pgp/IVlzKOv2OSI7w=;
	b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
	...
	bh=HSVLHkgMSUqxWcbc1T+fsQsit0Pgp/IVlzKOv2OSI7w=;
	b=
X-Forwarded-Encrypted: i=1;
	AJvYcCXnEhFJK8SFzgiDe8HxWIen08Ht/XSByVslm3oM3R6p+NP/cMeHktr3ed/uvSV/Ciw+81Tp0PXaCe2b9fROHDO/6g9nLsI+Mo/w
X-Gm-Message-State: AOJu0YymWXeZr+j8mpKOD+5VhuGpkiHEnK8ukGYB+6/B1iFftwr3O63B
	2nGcrIA3tYz1QoGvKsz5YZ+d2gCG4jC/RUvdzqXpmhpEC1HgL3wD
X-Google-Smtp-Source: AGHT+IG+MXhlW+QFpM6Rnupka8napxwJxRH0oCI9mys5+mxI/fFZ68OpTovznOA60BtwebCs2O4yVw==
X-Received: by 2002:a05:600c:6a9a:b0:422:50d7:ff0 with SMTP id
	5b1f17b1804b1-4247507a6f6mr19093275e9.3.1718810603126; 
...
X-Mailman-Approved-At: Thu, 20 Jun 2024 08:37:12 +0200
